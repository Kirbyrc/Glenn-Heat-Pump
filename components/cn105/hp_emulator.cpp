...
static const char *TAG = "HPEmulator";
...
void HPEmulator::uartInit() {
    ESP_LOGI(TAG, "Initializing HPEmulator");
    ...
    uart_driver_install(RE_UART_NUM, 256 * 2, 0, 0, NULL, 0);
    uart_param_config(RE_UART_NUM, &uart_config);
    uart_set_pin(RE_UART_NUM, RE_TX2_PIN, RE_RX2_PIN, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE);
